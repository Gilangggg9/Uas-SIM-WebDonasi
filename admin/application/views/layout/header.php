<header class="main-header dark-bg"> 
    ...
    <span class="logo-lg">UNSIA</span> </a> 
    <nav class="navbar navbar-static-top" role="navigation"> 
        <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button"> <span class="sr-only">Toggle navigation</span> </a>
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo base_url('assets/admin/img/adm1.jfif'); ?>" class="user-image" alt="User Image" /> <span class="hidden-xs">Yayasan Pundi Amal UNSIA</span> </a>
